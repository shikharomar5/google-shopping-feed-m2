...
namespace Ced\GShop\Block;
/**
 * Class Extensions
 * @package Ced\GShop\Block
 */
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    )
    {
        ...
        $this->_helper = $this->_objectManager->get('Ced\GShop\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $modules = $this->_objectManager->get('\Ced\GShop\Helper\Feed')->getAllModules();
    ...
    {
        $hash = \Ced\GShop\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_hash';
        $level = \Ced\GShop\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_level';

        $helper = $this->_objectManager->create('\Ced\GShop\Helper\Data');
        ...
        $l = $this->_objectManager->create('\Ced\GShop\Helper\Feed')->getLicenseFromHash($hash, $level);
