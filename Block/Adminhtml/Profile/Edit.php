...
namespace Ced\GShop\Block\Adminhtml\Profile;

/**
 * Class Edit
 * @package Ced\GShop\Block\Adminhtml\Profile
 */
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->updateButton(
            'save',
            'onclick',
            'saveAndContinueEdit(\'' . $this->getSaveAndContinueUrl('edit') . '\', true)'
        );
        ...
        $this->_formScripts[] = "
            function saveAndContinueEdit(urlTemplate,flag) {
                profileproduct_massaction = document.getElementById('profileproduct_massaction-form');
                if(profileproduct_massaction != null) {
                    profileproduct_massaction.parentElement.removeChild(profileproduct_massaction);
                     new Insertion.Bottom('edit_form',               
                     profileproduct_massactionJsObject.fieldTemplate(
                     {name: 'in_profile_products', 
                     value: profileproduct_massactionJsObject.checkedString}));
                 }
            if(flag) {
