...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    )
    {
        ...
        $this->setId('profileproduct');
        $this->_massactionBlockName = 'Ced\GShop\Block\Adminhtml\Profile\Widget\Grid\Massaction\Extended';
    ...
    {
        $profileAccount = $this->_coreRegistry->registry('google_account');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'sortable' => false,
                'type' => 'options',
                'options' => $this->_objectManager->create('Ced\GShop\Model\Source\Category')->getAllOptions(),
                'renderer' => 'Ced\GShop\Block\Adminhtml\Profile\Renderer\Category',
    ...
    public function getProducts($json = false)
    {
        ...
        $currentAccount = $this->_coreRegistry->registry('google_account');
        $ids = $this->_objectManager->create('Ced\GShop\Model\Profile')->getCollection()->addFieldToFilter('profile_code', $profileCode)->getColumnValues('id');
        if (!empty($ids)) {
            $profileAccountAttr = $this->multiAccountHelper->getProfileAttrForAcc($currentAccount->getId());
            // echo $profileAccountAttr; exit;
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'addproduct', array(
                ...
                'url' => $this->getUrl('gxpress/profile/save'),
            )
        );
        return $this;
    }
