    ...
    protected function _prepareForm()
    {
        ...
        /*$fieldset->addField('account_configuration_id', 'select',
            array(
                ...
                'required' => true,
                'values' => $this->_objectManager->get('Ced\GShop\Model\Source\AccountConfig\Configuration')->toOptionArray($profileAccount->getId()),
            )
        );*/
        ...
        $fieldset->addField('profile_status', 'select',
            array(
                ...
                'values' => $this->_objectManager->get('Ced\GShop\Model\Source\Profile\Status')->getOptionArray(),
            )
        );
