...
namespace Ced\GShop\Ui\Component\Listing\Columns\Product;
...
/**
 * Class Validation
 * @package Ced\GShop\Ui\Component\Listing\Columns\Product
 */
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[$fieldName])) {
                    if ($item[$fieldName] == '["valid"]' || $item[$fieldName] == "['valid']") {
                        $item[$fieldName . '_html'] = "<div class='grid-severity-notice'><span>valid</span></div>";
                        $item[$fieldName . '_title'] = __('GXpress Product Details');
