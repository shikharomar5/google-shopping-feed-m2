...
namespace Ced\GShop\Ui\Component\Listing\Columns\Profile;
...
{
    const URL_PATH_EDIT = 'gxpress/profile/edit';
    const URL_PATH_DELETE = 'gxpress/profile/delete';
    const URL_PATH_SYNC = 'gxpress/profile/sync';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['profile_code'])) {
                    $item[$name]['edit'] = [
                        'href' => $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['prcode' => $item['profile_code']]),
                        'label' => __('Edit'),
