...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!is_array($profileIds) && !$excluded) {
            ...
            $profileIds = $this->_objectManager->create('Ced\GShop\Model\Profile')->getCollection()->getAllIds();
        }
        ...
        if (!empty($profileIds)) {
            try {
                ...
                $this->_objectManager->create('Ced\GShop\Helper\Logger')->addError('In Mass Delete Profile: '.$e->getMessage(), ['path' => __METHOD__]);
